...
#define INCLUDE(x1,x2,y1,y2) (x1 >= x2 && y1 <= y2)
#define OVERLAP(x1,x2,y1,y2) (x1 < x2 && y1 < y2)

/* Memory layout */
/* Using NTKernel 32-bit layout */

#define USER_SPACE_START 0x0000000000000000
#define KERNEL_SPACE_START 0x0000000080000000

#define IS_KERNEL(x) x >= KERNEL_SPACE_START
