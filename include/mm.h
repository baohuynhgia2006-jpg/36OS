...
/* Memory Layout NTKernel with 32-bit DEFAULT */
#define USER_SPACE_START 0
#define USER_SPACE_END 0x00007FFFFFFFF
#define KERNEL_SPACE_START 0x000800000000
#define KERNEL_SPACE_END 0x000FFFFFFFFF

#define USER_MODE(X) X >= USER_SPACE_START && X <= USER_SPACE_END
#define KERNEL_MODE(X) X >= KERNEL_SPACE_START && X <= KERNEL_SPACE_END
